...
class test_numista_issue(TestCase):
    databases = {'numista'}
    ...
    def setUpClass(cls):
        ...
        FixtureCoins.COUNTRY_1.save()
        FixtureCoins.CURRENCY_1.save()
    ...
    def test_add(self):
        ...
        self.assertEqual(str(result), '{}: {} {}'.format(
            Consts.ISSUE.NUMISTA_ID_1, Consts.COIN.NAME_1, Consts.ISSUE.YEAR_1))
